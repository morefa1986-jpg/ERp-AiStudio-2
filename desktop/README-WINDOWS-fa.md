...
## تنظیم یا بازنشانی ادمین

بعد از اولین اجرای برنامه، اگر لازم بود ادمین اصلی را بسازید یا رمز او را ریست کنید، PowerShell را باز کنید و ابزار زیر را اجرا کنید:

```powershell
.\tools\Set-FathiAquaSuperERP-Admin.ps1 -Username "morefa1986"
```

رمز را همان لحظه وارد کنید. رمز به‌صورت hash امن داخل دیتابیس ثبت می‌شود و متن خام رمز داخل فایل‌های برنامه ذخیره نمی‌شود.

...
const MODULE_PRIORITY: PermissionModule[] = [
  ...
  'processing', 'sales', 'documents', 'gatehouse', 'accounting', 'hr', 'warehouse', 'feed_factory', 'hatchery',
  'nursery', 'laboratory', 'crm', 'media', 'chat', 'backup', 'settings',
];
...
const COLLECTION_HINTS: Array<{ collection: string; module: PermissionModule }> = [
  ...
  { collection: 'gatePasses', module: 'gatehouse' },
  { collection: 'chatThreads', module: 'chat' },
  { collection: 'chatMessages', module: 'chat' },

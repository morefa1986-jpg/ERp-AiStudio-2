...
export const MODULE_CATALOG: ModuleCatalogItem[] = [
  ...
  { id: 'gatehouse', titleFa: 'نگهبانی و برگه خروج', titleEn: 'Gatehouse', descriptionFa: 'ثبت ورود/خروج خودرو، بارنامه، حواله، مجوز حمل و صدور برگه خروج', section: 'commercial' },
  { id: 'chat', titleFa: 'چت داخلی', titleEn: 'Internal Chat', descriptionFa: 'پیام فردی/گروهی و پیوست فایل، عکس و فیلم داخل شبکه مجموعه', section: 'commercial' },

...
const COPY = {
  fa: {
    ...
    safeMode: 'حالت امن بدون API',
    statsExplainer: 'این شمارنده‌ها فقط از رکوردهای گردش‌کار ERP می‌آیند. لایک، بازدید، دنبال‌کننده، کامنت و دایرکت بدون اتصال رسمی جعل نمی‌شوند.',
    ...
    connected: 'متصل', assistedReady: 'آماده انتشار کمکی', notConnected: 'متصل نیست', login: 'باز کردن صفحه ورود', confirmConnection: 'تأیید اتصال', disconnect: 'قطع اتصال',
    ...
    accountLabelPrompt: 'برچسب حساب / صفحه (اختیاری):', desktop: 'دسکتاپ', closeImageEditor: 'بستن ویرایشگر تصویر', brightness: 'روشنایی', contrast: 'کنتراست', saveEditedCopy: 'ذخیره نسخه ویرایش‌شده',
  ...
  en: {
    ...
    safeMode: 'No-API Safe Mode',
    statsExplainer: 'These counters come only from ERP workflow records. Likes, reach, followers, comments and direct messages are not fabricated when no official platform integration is available.',
    ...
    connected: 'Connected', assistedReady: 'Assisted publishing ready', notConnected: 'Not connected', login: 'Open sign-in page', confirmConnection: 'Confirm connection', disconnect: 'Disconnect',
    ...
    accountLabelPrompt: 'Account / page label (optional):', desktop: 'Desktop', closeImageEditor: 'Close image editor', brightness: 'Brightness', contrast: 'Contrast', saveEditedCopy: 'Save edited copy',
  ...
  de: {
    ...
    overview: 'Übersicht', accounts: 'Konten', library: 'Medienbibliothek', composer: 'Beitrag erstellen', queue: 'Freigabe & Veröffentlichung', noApi: 'Sicherer Modus ohne API: ERP speichert keine Passwörter. Anmeldung erfolgt auf der offiziellen Plattform.', safeMode: 'Sicherer Modus ohne API', statsExplainer: 'Diese Zähler stammen nur aus ERP-Workflow-Datensätzen. Likes, Reichweite, Follower, Kommentare und Direktnachrichten werden ohne offizielle Integration nicht erfunden.', internalStats: 'Interne ERP-Statistik', connectedAccounts: 'Verbundene Konten', pendingApproval: 'Wartet auf Freigabe', approvedReady: 'Freigegeben / bereit', published: 'Veröffentlicht', connected: 'Verbunden', assistedReady: 'Assistierte Veröffentlichung bereit', notConnected: 'Nicht verbunden', login: 'Anmeldung öffnen', confirmConnection: 'Verbindung bestätigen', disconnect: 'Trennen', upload: 'Foto oder Video hinzufügen', noMedia: 'Noch keine Medien gespeichert.', editImage: 'Bild bearbeiten', videoDesktop: 'Vollständige Videobearbeitung lokal in der Desktop-Version', accountLabelPrompt: 'Konto-/Seitenlabel (optional):', desktop: 'Desktop', closeImageEditor: 'Bildeditor schließen', brightness: 'Helligkeit', contrast: 'Kontrast', saveEditedCopy: 'Bearbeitete Kopie speichern', titleLabel: 'Interner Titel', captionLabel: 'Text', hashtagsLabel: 'Hashtags', scheduleLabel: 'Vorgesehene Zeit', channelsLabel: 'Zielkanäle', selectMedia: 'Medien wählen', saveDraft: 'Entwurf speichern', requestApproval: 'Freigabe anfordern', approvalRequired: 'Keine echte Veröffentlichung ohne Admin-Freigabe.', approve: 'Freigeben', reject: 'Ablehnen', edit: 'Bearbeiten', prepare: 'Veröffentlichung vorbereiten', markPublished: 'Als veröffentlicht markieren', openPlatform: 'Plattform öffnen', copyCaption: 'Text kopieren', delete: 'Löschen', noDrafts: 'Warteschlange ist leer.', saved: 'Gespeichert.', mediaSaved: 'Medien offline gespeichert.', imageSaved: 'Bearbeitete Bildversion gespeichert.',
  },
  fr: {
    ...
    overview: 'Tableau de bord', accounts: 'Comptes', library: 'Médiathèque', composer: 'Créer / modifier', queue: 'Validation & publication', noApi: 'Mode sécurisé sans API : aucun mot de passe social n’est stocké. La connexion se fait sur le site officiel.', safeMode: 'Mode sécurisé sans API', statsExplainer: 'Ces compteurs proviennent uniquement des workflows ERP. Les likes, la portée, les abonnés, commentaires et messages directs ne sont pas inventés sans intégration officielle.', internalStats: 'Statistiques internes ERP', connectedAccounts: 'Comptes connectés', pendingApproval: 'En attente', approvedReady: 'Validé / prêt', published: 'Publié', connected: 'Connecté', assistedReady: 'Publication assistée prête', notConnected: 'Non connecté', login: 'Ouvrir la connexion', confirmConnection: 'Confirmer la connexion', disconnect: 'Déconnecter', upload: 'Ajouter photo ou vidéo', noMedia: 'Aucun média enregistré.', editImage: 'Modifier l’image', videoDesktop: 'Montage vidéo complet via le moteur local Desktop', accountLabelPrompt: 'Libellé du compte / page (facultatif) :', desktop: 'Desktop', closeImageEditor: 'Fermer l’éditeur d’image', brightness: 'Luminosité', contrast: 'Contraste', saveEditedCopy: 'Enregistrer la copie modifiée', titleLabel: 'Titre interne', captionLabel: 'Légende', hashtagsLabel: 'Hashtags', scheduleLabel: 'Heure prévue', channelsLabel: 'Canaux cibles', selectMedia: 'Choisir les médias', saveDraft: 'Enregistrer le brouillon', requestApproval: 'Demander validation', approvalRequired: 'Aucune publication réelle sans validation administrateur.', approve: 'Valider', reject: 'Refuser', edit: 'Modifier', prepare: 'Préparer la publication', markPublished: 'Marquer publié', openPlatform: 'Ouvrir la plateforme', copyCaption: 'Copier la légende', delete: 'Supprimer', noDrafts: 'La file est vide.', saved: 'Enregistré.', mediaSaved: 'Média enregistré hors ligne.', imageSaved: 'Version modifiée enregistrée.',
  },
  es: {
    ...
    overview: 'Panel', accounts: 'Cuentas', library: 'Biblioteca', composer: 'Crear / editar', queue: 'Aprobación y publicación', noApi: 'Modo seguro sin API: el ERP no guarda contraseñas. El inicio de sesión ocurre en el sitio oficial.', safeMode: 'Modo seguro sin API', statsExplainer: 'Estos contadores proceden solo de registros del flujo ERP. Likes, alcance, seguidores, comentarios y mensajes directos no se inventan sin integración oficial.', internalStats: 'Estadísticas internas ERP', connectedAccounts: 'Cuentas conectadas', pendingApproval: 'Pendiente de aprobación', approvedReady: 'Aprobado / listo', published: 'Publicado', connected: 'Conectado', assistedReady: 'Publicación asistida lista', notConnected: 'No conectado', login: 'Abrir inicio de sesión', confirmConnection: 'Confirmar conexión', disconnect: 'Desconectar', upload: 'Añadir foto o vídeo', noMedia: 'Aún no hay medios.', editImage: 'Editar imagen', videoDesktop: 'Edición completa de vídeo con el motor local Desktop', accountLabelPrompt: 'Etiqueta de cuenta / página (opcional):', desktop: 'Desktop', closeImageEditor: 'Cerrar editor de imagen', brightness: 'Brillo', contrast: 'Contraste', saveEditedCopy: 'Guardar copia editada', titleLabel: 'Título interno', captionLabel: 'Texto', hashtagsLabel: 'Hashtags', scheduleLabel: 'Hora sugerida', channelsLabel: 'Canales objetivo', selectMedia: 'Seleccionar medios', saveDraft: 'Guardar borrador', requestApproval: 'Solicitar aprobación', approvalRequired: 'Nada se publica realmente sin aprobación del administrador.', approve: 'Aprobar', reject: 'Rechazar', edit: 'Editar', prepare: 'Preparar publicación', markPublished: 'Marcar publicado', openPlatform: 'Abrir plataforma', copyCaption: 'Copiar texto', delete: 'Eliminar', noDrafts: 'La cola está vacía.', saved: 'Guardado.', mediaSaved: 'Medio guardado sin conexión.', imageSaved: 'Versión editada guardada.',
  },
  ru: {
    ...
    overview: 'Панель', accounts: 'Аккаунты', library: 'Медиатека', composer: 'Создать / изменить', queue: 'Согласование и публикация', noApi: 'Безопасный режим без API: ERP не хранит пароли. Вход выполняется на официальном сайте платформы.', safeMode: 'Безопасный режим без API', statsExplainer: 'Эти счетчики берутся только из записей workflow ERP. Лайки, охват, подписчики, комментарии и личные сообщения не выдумываются без официальной интеграции.', internalStats: 'Внутренняя статистика ERP', connectedAccounts: 'Подключено', pendingApproval: 'На согласовании', approvedReady: 'Одобрено / готово', published: 'Опубликовано', connected: 'Подключено', assistedReady: 'Помощь публикации готова', notConnected: 'Не подключено', login: 'Открыть вход', confirmConnection: 'Подтвердить подключение', disconnect: 'Отключить', upload: 'Добавить фото или видео', noMedia: 'Медиа пока нет.', editImage: 'Редактировать изображение', videoDesktop: 'Полный видеомонтаж — локальный Desktop-движок', accountLabelPrompt: 'Метка аккаунта / страницы (необязательно):', desktop: 'Desktop', closeImageEditor: 'Закрыть редактор изображения', brightness: 'Яркость', contrast: 'Контраст', saveEditedCopy: 'Сохранить измененную копию', titleLabel: 'Внутреннее название', captionLabel: 'Подпись', hashtagsLabel: 'Хэштеги', scheduleLabel: 'Планируемое время', channelsLabel: 'Каналы', selectMedia: 'Выбрать медиа', saveDraft: 'Сохранить черновик', requestApproval: 'Отправить на согласование', approvalRequired: 'Без одобрения администратора реальная публикация невозможна.', approve: 'Одобрить', reject: 'Отклонить', edit: 'Изменить', prepare: 'Подготовить публикацию', markPublished: 'Отметить опубликованным', openPlatform: 'Открыть платформу', copyCaption: 'Копировать текст', delete: 'Удалить', noDrafts: 'Очередь пуста.', saved: 'Сохранено.', mediaSaved: 'Медиа сохранено локально.', imageSaved: 'Отредактированная версия сохранена.',
  },
  ar: {
    ...
    overview: 'لوحة التحكم', accounts: 'الحسابات', library: 'مكتبة الوسائط', composer: 'إنشاء وتعديل', queue: 'الموافقة والنشر', noApi: 'وضع آمن دون API: لا يحفظ ERP كلمات مرور الشبكات، ويتم تسجيل الدخول في الموقع الرسمي.', safeMode: 'وضع آمن دون API', statsExplainer: 'هذه العدادات تأتي فقط من سجلات سير العمل في ERP. لا يتم اختلاق الإعجابات أو الوصول أو المتابعين أو التعليقات أو الرسائل دون تكامل رسمي.', internalStats: 'إحصاءات ERP الداخلية', connectedAccounts: 'حسابات متصلة', pendingApproval: 'بانتظار الموافقة', approvedReady: 'موافق عليه / جاهز', published: 'منشور', connected: 'متصل', assistedReady: 'النشر المساعد جاهز', notConnected: 'غير متصل', login: 'فتح صفحة الدخول', confirmConnection: 'تأكيد الاتصال', disconnect: 'فصل الاتصال', upload: 'إضافة صورة أو فيديو', noMedia: 'لا توجد وسائط محفوظة بعد.', editImage: 'تعديل الصورة', videoDesktop: 'تحرير الفيديو الكامل عبر المحرك المحلي لنسخة سطح المكتب', accountLabelPrompt: 'تسمية الحساب / الصفحة (اختياري):', desktop: 'سطح المكتب', closeImageEditor: 'إغلاق محرر الصورة', brightness: 'السطوع', contrast: 'التباين', saveEditedCopy: 'حفظ نسخة معدلة', titleLabel: 'العنوان الداخلي', captionLabel: 'النص', hashtagsLabel: 'الوسوم', scheduleLabel: 'وقت النشر المقترح', channelsLabel: 'القنوات المستهدفة', selectMedia: 'اختيار الوسائط', saveDraft: 'حفظ مسودة', requestApproval: 'طلب موافقة المدير', approvalRequired: 'لا يتم أي نشر فعلي دون موافقة المدير.', approve: 'موافقة المدير', reject: 'رفض', edit: 'تعديل', prepare: 'تجهيز النشر', markPublished: 'تسجيل كمنشور', openPlatform: 'فتح الشبكة', copyCaption: 'نسخ النص', delete: 'حذف', noDrafts: 'قائمة المحتوى فارغة.', saved: 'تم الحفظ.', mediaSaved: 'تم حفظ الوسائط محلياً.', imageSaved: 'تم حفظ النسخة المعدلة.',
  },
} as const;
...
export const SocialMediaCommandCenterView: React.FC = () => {
  ...
  const connectedCount = connections.filter((item) => item.connected || item.assistedReady).length;
  ...
  const connectPlatform = async (platformId: SocialPlatformId) => {
    if (!canEdit) return;
    const label = window.prompt(c.accountLabelPrompt) || undefined;
  ...
  return (
    <div dir={dir} className="space-y-5 animate-fadeIn pb-12">
      <div className="bg-[#121214] border border-[#1F1F22] rounded-2xl p-5">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="px-3 py-2 rounded-xl border border-emerald-500/30 bg-emerald-500/10 text-emerald-300 text-xs flex items-center gap-2">
            <ShieldCheck className="w-4 h-4" /> {c.safeMode}
          </div>
        </div>
      ...
      {activeTab === 'overview' && (
        <div className="space-y-5">
          ...
          <div className="bg-[#121214] border border-[#1F1F22] rounded-2xl p-5">
            ...
            <p className="text-xs text-[#71717A] mt-2">{c.statsExplainer}</p>
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
          {SOCIAL_PLATFORMS.map((platform) => {
            ...
            return <div key={platform.id} className="bg-[#121214] border border-[#1F1F22] rounded-2xl p-4 space-y-3">
              <div className="flex items-center justify-between"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-xl bg-[#18181B] border border-[#27272A] flex items-center justify-center text-xs font-bold text-[#D4AF37]">{platform.colorHint}</div><div><div className="text-sm font-bold text-white">{platform.name}</div><div className={`text-[10px] ${connection?.assistedReady ? 'text-emerald-400' : 'text-[#71717A]'}`}>{connection?.connected ? c.connected : connection?.assistedReady ? c.assistedReady : c.notConnected}{connection?.accountLabel ? ` · ${connection.accountLabel}` : ''}</div></div></div>{connection?.assistedReady && <CheckCircle2 className="w-5 h-5 text-emerald-400" />}</div>
              <div className="grid grid-cols-2 gap-2"><button onClick={() => openPlatformLogin(platform.id)} className="py-2 rounded-lg bg-[#18181B] border border-[#27272A] text-xs text-white flex items-center justify-center gap-1"><LogIn className="w-3.5 h-3.5" />{c.login}</button>{connection?.assistedReady ? <button onClick={() => void setSocialConnection(platform.id, false).then(setConnections)} className="py-2 rounded-lg bg-rose-500/10 border border-rose-500/30 text-xs text-rose-300">{c.disconnect}</button> : <button onClick={() => void connectPlatform(platform.id)} className="py-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-xs text-emerald-300">{c.confirmConnection}</button>}</div>
            </div>;
          })}
        </div>
      )}
      ...
      {editingAsset && (
        <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4"><div className="w-full max-w-xl bg-[#121214] border border-[#27272A] rounded-2xl p-5 space-y-4"><div className="flex items-center justify-between"><h3 className="text-sm font-bold text-white">{c.editImage}</h3><button type="button" aria-label={c.closeImageEditor} onClick={() => setEditingAsset(null)} className="text-[#71717A]">×</button></div><MediaPreview asset={editingAsset} className="w-full max-h-72 rounded-xl" /><div><label className="text-xs text-[#A1A1AA]">{c.brightness}: {brightness}%</label><input type="range" min="40" max="160" value={brightness} onChange={(e) => setBrightness(Number(e.target.value))} className="w-full" /></div><div><label className="text-xs text-[#A1A1AA]">{c.contrast}: {contrast}%</label><input type="range" min="40" max="160" value={contrast} onChange={(e) => setContrast(Number(e.target.value))} className="w-full" /></div><div className="flex gap-2">{([0, 90, 180, 270] as const).map((deg) => <button type="button" key={deg} onClick={() => setRotation(deg)} className={`flex-1 py-2 rounded-lg border text-xs ${rotation === deg ? 'border-[#D4AF37] text-[#D4AF37]' : 'border-[#27272A] text-[#A1A1AA]'}`}>{deg}°</button>)}</div><button type="button" onClick={() => void saveEditedImage()} className="w-full py-2.5 rounded-xl bg-[#D4AF37] text-black font-bold text-xs">{c.saveEditedCopy}</button></div></div>
      )}
    </div>
  );
};

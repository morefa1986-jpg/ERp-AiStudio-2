...
export const BackupRestoreView: React.FC = () => {
  ...
  return <div className="space-y-6 pb-12 animate-fadeIn">
    ...
    <div className="rounded-2xl border border-amber-500/25 bg-amber-500/10 p-4 text-xs text-amber-100 leading-6 flex gap-3"><AlertTriangle className="w-5 h-5 shrink-0 mt-0.5" /><div><strong className="text-amber-200 block mb-1">حد واقعی Disaster Recovery</strong>این فایل، داده‌های عملیاتی ERP و Snapshotهای قابل Restore را رمزنگاری می‌کند. رمز عبور کاربران، Tokenها، Credential سرویس‌های بیرونی، Driver دستگاه حضور و غیاب، تنظیمات Windows Scheduler/NAS/USB و متغیرهای محیطی Server عمداً داخل فایل صادر نمی‌شوند. برای Disaster Recovery کامل نصب تجاری، باید این فایل همراه با DB/پوشه نصب، فایل‌های تنظیمات Server و مستندات Credential rotation نگهداری شود.</div></div>

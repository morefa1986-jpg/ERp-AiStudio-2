...
type ReportType = 'ponds' | 'feeding' | 'water' | 'mortality' | 'treatments' | 'transfers' | 'inventory' | 'laboratory' | 'processing' | 'sales' | 'receivables' | 'documents' | 'gatehouse' | 'chat' | 'accounting' | 'payroll' | 'audit';
...
const REPORT_LABELS: Record<ReportType, string> = {
  ...
  inventory: 'انبار', laboratory: 'آزمایشگاه', processing: 'فرآوری', sales: 'فروش', receivables: 'مطالبات و سررسید', documents: 'دبیرخانه و اسناد', gatehouse: 'نگهبانی و برگه خروج', chat: 'چت داخلی', accounting: 'حسابداری', payroll: 'حقوق', audit: 'Audit Trail',
};

const SCOPED_REPORTS = new Set<ReportType>(['ponds', 'feeding', 'water', 'mortality', 'treatments', 'transfers', 'processing', 'sales', 'receivables']);
const DATED_REPORTS = new Set<ReportType>(['feeding', 'water', 'mortality', 'treatments', 'transfers', 'laboratory', 'processing', 'sales', 'receivables', 'documents', 'gatehouse', 'chat', 'accounting', 'payroll', 'audit']);
